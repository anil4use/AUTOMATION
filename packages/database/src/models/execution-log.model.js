...
const TimelineEntrySchema = new mongoose_1.Schema({ phase: String, startMs: Number, endMs: Number }, { _id: false });
const StepTimingSchema = new mongoose_1.Schema({
...
const HttpRequestLogSchema = new mongoose_1.Schema({
    method: { type: String },
    url: { type: String },
    headers: { type: mongoose_1.Schema.Types.Mixed }, // Authorization values masked → "Bearer ***"
    body: { type: mongoose_1.Schema.Types.Mixed },
    sentAt: { type: Date },
}, { _id: false });
const HttpResponseLogSchema = new mongoose_1.Schema({
...
const AiBridgeLogSchema = new mongoose_1.Schema({
    ...
    mappingDecisions: { type: mongoose_1.Schema.Types.Mixed }, // { fieldKey: "explanation" }
...
const CoercionEventSchema = new mongoose_1.Schema({
    field: { type: String },
...
const SanitizationEventSchema = new mongoose_1.Schema({
    field: { type: String },
...
const ValidationErrorSchema = new mongoose_1.Schema({
    field: { type: String },
...
const CredentialResolutionSchema = new mongoose_1.Schema({
...
const StepErrorSchema = new mongoose_1.Schema({
...
// ─── Per-Step Log Schema ────────────────────────────────────────────────────────
const StepExecutionLogSchema = new mongoose_1.Schema({
    ...
    rawInputFromPreviousStep: { type: mongoose_1.Schema.Types.Mixed },
    userFieldMappingOverrides: { type: mongoose_1.Schema.Types.Mixed },
    nodeConfig: { type: mongoose_1.Schema.Types.Mixed },
    ...
    resolvedInputs: { type: mongoose_1.Schema.Types.Mixed }, // secrets masked (token → "***")
    ...
    normalizedOutput: { type: mongoose_1.Schema.Types.Mixed },
    // Phase 10: Error
...
const ExecutionSummarySchema = new mongoose_1.Schema({
...
const ExecutionLogSchema = new mongoose_1.Schema({
    workflowId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Workflow', index: true },
    ...
    nodeResults: { type: mongoose_1.Schema.Types.Mixed, default: {} }, // backward compat
...
exports.ExecutionLogModel = (0, mongoose_1.model)('ExecutionLog', ExecutionLogSchema);
